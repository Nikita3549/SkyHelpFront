          ...
          <div className="order-2 lg:order-1">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
                Earn Money with SkyHelp!
              </h1>
              <p className="text-xl text-gray-600 mb-8 max-w-2xl">
                Share our platform with friends, followers, and your audience —
                and earn generous commissions for every successful claim.
              </p>
            ...
            >
              <div className="relative w-full max-w-lg">
                <img
                  ...
                  src="/lovable-uploads/24273f87-f4c9-41ca-87ef-12c1ac90a8f5.jpg"
                />
                <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-lg shadow-lg">
                  <div className="text-lg font-semibold text-primary">25 €</div>
                  <div className="text-sm text-gray-600">
                    from every successful claim
                  </div>
                </div>
              </div>
            </motion.div>
