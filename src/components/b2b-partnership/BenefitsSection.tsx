...
const benefits = [
  ...
  },
  {
    ...
    description:
      'Use direct links, referral dashboards, or API integration — whichever suits your platform best.',
  ...
  },
  {
    ...
    description:
      'Track performance, earnings, and client activity live. Export reports and monitor success.',
