...
const CancelledFlightCompensation = () => {
  ...
  const tableOfContents = [
    ...
    { id: "compensation-amount", title: "How Much Compensation Can You Claim?" },
    { id: "additional-rights", title: "Additional Rights During Cancellations" },
  ...
  return (
    ...
    >
      <h2 id="understanding" className="text-2xl font-bold mb-4 scroll-mt-24">Understanding Flight Cancellations</h2>
      <div className="bg-blue-50 p-6 rounded-lg mb-6">
        <p className="text-lg">
          <strong>Quick Summary:</strong> Under EU Regulation 261/2004, if your flight is cancelled and you were 
          informed less than 14 days before departure, you could be entitled to compensation of up to €600, 
          unless the cancellation was caused by extraordinary circumstances.
        </p>
      </div>
      ...
      <h3 id="eligibility" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">When Can You Claim Compensation for a Cancelled Flight?</h3>
      <p>
      ...
      <ul className="list-disc pl-6 mb-6 space-y-2">
        ...
        <li>You checked in for your flight on time (or would have if the flight hadn't been cancelled)</li>
      </ul>
      ...
      <h3 id="compensation-amount" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">How Much Compensation Can You Claim?</h3>
      <p className="mb-4">
      ...
      <div className="overflow-x-auto my-6">
        <Table>
          ...
          <TableBody>
            ...
            <TableRow className="bg-gray-50">
              <TableCell>Over 3,500 km (between EU and non-EU airport)</TableCell>
      ...
      <p>
        It's important to note that compensation is calculated based on the scheduled flight's route and distance, 
        not the alternative flight you may have been offered.
      </p>

      <h3 id="additional-rights" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">Additional Rights During Cancellations</h3>
      <p>
      ...
      <h3 id="extraordinary" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">What Are "Extraordinary Circumstances"?</h3>
      <p>
      ...
      <div className="bg-blue-50 p-6 rounded-lg my-6">
        ...
        <p>
          Technical issues with the aircraft are generally NOT considered extraordinary circumstances following 
          European Court of Justice rulings, as they're considered part of the normal operation of an airline.
          Airlines often incorrectly claim technical issues as extraordinary circumstances to avoid paying compensation.
        </p>
      </div>

      <h3 id="how-to-claim" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">How To Claim Compensation for a Cancelled Flight</h3>
      <div className="bg-blue-50 p-6 rounded-lg my-4">
        <h4 className="font-semibold text-lg mb-3">Step by Step Guide:</h4>
        <ol className="list-decimal pl-6 space-y-2">
          <li>Gather all relevant documentation (booking confirmation, communication about the cancellation)</li>
          <li>Check if you're eligible based on the notice period and circumstances of the cancellation</li>
          <li>Calculate your potential compensation based on flight distance</li>
      ...
      <p>
        When submitting your claim, be clear, concise, and include all relevant documentation. Reference EU Regulation 261/2004 
        specifically and state the compensation amount you're entitled to based on the flight distance.
      </p>

      <h3 id="time-limits" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">Time Limits for Claiming Compensation</h3>
      <p>
      ...
      <p>
        It's advisable to submit your claim as soon as possible after the cancellation to ensure all details are fresh and relevant documentation is available.
      </p>

      <h3 id="faq" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">Frequently Asked Questions</h3>
      <div className="space-y-4 mb-6">
        <div className="border-b pb-4">
          <p><strong>Can I claim if my flight was cancelled due to COVID-19?</strong></p>
          <p>Generally, cancellations due to government travel restrictions related to COVID-19 would likely be considered extraordinary circumstances. However, each case is unique and may have different outcomes.</p>
        </div>
        <div className="border-b pb-4">
          <p><strong>What if I accepted a voucher instead of a refund?</strong></p>
          <p>Accepting a voucher for a future flight doesn't necessarily affect your right to claim compensation. However, if you accepted a voucher explicitly as a full settlement for all claims, this might impact your case.</p>
        </div>
        <div className="border-b pb-4">
          <p><strong>Can I claim for expenses incurred due to the cancellation?</strong></p>
          <p>EU261 compensation is standardized and doesn't cover additional expenses. However, you might be able to claim for reasonable expenses through your travel insurance or, in some cases, from the airline if they failed to provide the care they were required to.</p>
        </div>
        <div>
          <p><strong>What if my connecting flight was cancelled?</strong></p>
          <p>If your journey involved connecting flights booked as a single reservation and one leg was cancelled, you may be entitled to compensation based on the total distance of the journey to the final destination.</p>
        </div>
      </div>
