...
const features = [
  ...
  },
  {
    ...
    description:
      'All passenger data is handled with strict adherence to privacy regulations.',
    icon: <Shield size={24} />,
  },
  {
    title: 'Trusted by thousands of passengers',
    description:
      'Our proven track record and high success rate speaks for itself.',
    icon: <UserCheck size={24} />,
  },
  {
    title: 'Transparent communication and dedicated account manager',
    description:
      'Get personalized support and clear communication throughout our partnership.',
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Partner with a platform that delivers results for both you and your
            customers.
          </p>
        </motion.div>
