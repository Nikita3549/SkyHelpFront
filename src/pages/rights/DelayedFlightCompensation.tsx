...
const DelayedFlightCompensation = () => {
  ...
  return (
    ...
    >
      <h2 id="understanding" className="text-2xl font-bold mb-4 scroll-mt-24">Understanding Flight Delays</h2>
      <div className="bg-blue-50 p-6 rounded-lg mb-6">
        <p className="text-lg">
          <strong>Quick Summary:</strong> Under EU Regulation 261/2004, if your flight is delayed by 3 or more hours, 
          you could be entitled to compensation of up to €600, depending on the flight distance and as long as the 
          delay wasn't caused by extraordinary circumstances.
        </p>
      </div>
      ...
      <h3 id="eligibility" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">When Can You Claim Compensation for a Delayed Flight?</h3>
      <p>
      ...
      <ul className="list-disc pl-6 mb-6 space-y-2">
        ...
        <li>You've made the claim within the specified time limits (varies by country)</li>
      </ul>
      ...
      <h3 id="additional-rights" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">Additional Rights During a Delay</h3>
      <p>
      ...
      <div className="bg-gray-50 p-5 rounded-lg mb-5">
        ...
        <p className="mb-2">
          During long delays, the airline must provide:
        </p>
      ...
      <div className="bg-blue-50 p-6 rounded-lg my-6">
        ...
        <p>
          Most technical problems are NOT considered extraordinary circumstances following European Court of Justice rulings,
          as they're considered inherent to the normal activity of an airline. Airlines often incorrectly claim technical issues 
          as extraordinary circumstances to avoid paying compensation.
        </p>
      </div>

      <h3 id="how-to-claim" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">How To Claim Compensation for a Delayed Flight</h3>
      ...
      <p>
        ...
        specifically and state the compensation amount you're entitled to based on the flight distance and delay time.
      </p>
      ...
      <h3 id="myths" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">Common Myths About Flight Delay Compensation</h3>
      <div className="space-y-4 mb-6">
        <div className="border-b pb-4">
          <p><strong>Myth:</strong> You need to have travel insurance to claim compensation.</p>
          <p><strong>Fact:</strong> EU261 compensation is a legal right independent of any insurance.</p>
        </div>
        <div className="border-b pb-4">
          <p><strong>Myth:</strong> You can only claim compensation if your flight was booked directly with the airline.</p>
          <p><strong>Fact:</strong> You can claim regardless of how you booked (directly, via a travel agent, or as part of a package).</p>
        </div>
        <div className="border-b pb-4">
          <p><strong>Myth:</strong> Technical issues always qualify as extraordinary circumstances.</p>
          <p><strong>Fact:</strong> Most technical problems are considered part of an airline's normal operations.</p>
        </div>
        <div>
          <p><strong>Myth:</strong> Airlines will automatically compensate you if your flight is delayed.</p>
          <p><strong>Fact:</strong> You almost always need to actively submit a claim to receive compensation.</p>
        </div>
      </div>
