...
import { AlertCircle, Clock, Luggage, CheckCircle, BaggageClaim, AlertTriangle, Info } from "lucide-react";
...
const DelayedBaggageCompensation = () => {
  ...
  const tableOfContents = [
    { id: "legal-framework", title: "Legal Framework: The Montreal Convention" },
  ...
  return (
    ...
    >
      <div className="bg-blue-50 p-6 rounded-lg mb-6">
        <p className="text-lg">
          <strong>Quick Summary:</strong> When your baggage is delayed, damaged, or lost during air travel, you're entitled 
          to compensation under the Montreal Convention. Maximum compensation is approximately 1,288 SDR (about €1,500/$1,780) 
          per passenger. You must report damaged baggage within 7 days, delayed baggage within 21 days, and any legal claim 
          must be filed within 2 years. Always file a Property Irregularity Report (PIR) before leaving the airport.
        </p>
      </div>
      ...
      <h3 id="legal-framework" className="text-2xl font-bold mt-8 mb-4 scroll-mt-24">Legal Framework: The Montreal Convention</h3>
      <div className="grid md:grid-cols-2 gap-6 my-6">
        ...
        <div className="bg-gray-50 p-6 rounded-lg">
          ...
          <p>
            Under the Montreal Convention, airlines are liable for delayed, damaged, and lost baggage with a maximum 
            compensation of approximately 1,288 Special Drawing Rights (SDR) per passenger (approximately €1,500 or $1,780, 
            though exact amounts fluctuate with exchange rates).
          </p>
        </div>
      </div>

      <h3 id="baggage-issues" className="text-2xl font-bold mt-8 mb-4 scroll-mt-24">Types of Baggage Issues and Your Rights</h3>
        ...
        <Table>
          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell>Report immediately and file written claim within 21 days</TableCell>
            </TableRow>
      ...
      <h3 id="steps" className="text-2xl font-bold mt-8 mb-4 scroll-mt-24">Steps to Take When Your Baggage is Mishandled</h3>
      ...
      <h3 id="compensation-claims" className="text-2xl font-bold mt-8 mb-4 scroll-mt-24">Maximizing Your Compensation Claim</h3>
      ...
      <div className="grid md:grid-cols-2 gap-6 my-6">
        ...
        <div className="bg-gray-50 p-6 rounded-lg">
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Follow up persistently if you don't receive a timely response</li>
            <li>Consider travel insurance that offers additional baggage protection</li>
          </ul>
        </div>
      </div>

      <h3 id="liability" className="text-2xl font-bold mt-8 mb-4 scroll-mt-24">Airline Liability Limitations</h3>
      <p className="mb-4">
        ...
        <Table>
          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell className="text-red-500">Limited or no coverage</TableCell>
              <TableCell>Carry in cabin baggage</TableCell>
            </TableRow>
            <TableRow className="bg-gray-50">
              <TableCell>Electronics and valuables</TableCell>
              <TableCell className="text-red-500">Limited or no coverage</TableCell>
              <TableCell>Carry in cabin baggage or purchase insurance</TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Cash and documents</TableCell>
              <TableCell className="text-red-500">Usually not covered</TableCell>
              <TableCell>Always carry in cabin baggage</TableCell>
            </TableRow>
            <TableRow className="bg-gray-50">
              <TableCell>Regular clothing/items</TableCell>
              <TableCell className="text-amber-500">Covered with depreciation applied</TableCell>
              <TableCell>Document value before travel</TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Any item over SDR limit</TableCell>
              <TableCell className="text-amber-500">Only covered up to maximum limit</TableCell>
      ...
      <div className="flex items-center bg-amber-50 p-5 rounded-lg mb-6">
        ...
        <p>
          ...
          Airlines have a maximum liability cap of approximately 1,288 SDR per passenger regardless of the actual value of your luggage.
        </p>
      </div>

      <h3 id="prevention" className="text-2xl font-bold mt-8 mb-4 scroll-mt-24">Tips for Preventing Baggage Issues</h3>
      ...
      <h3 id="faq" className="text-2xl font-bold mt-8 mb-4 scroll-mt-24">Frequently Asked Questions</h3>
      <Accordion type="single" collapsible className="mb-8">
        <AccordionItem value="item-1">
          <AccordionTrigger className="text-lg font-medium">What's the difference between delayed and lost baggage?</AccordionTrigger>
          <AccordionContent className="text-gray-700">
            Baggage is considered "delayed" when it doesn't arrive with your flight but the airline knows where it is and expects 
            to deliver it to you. Most airlines consider baggage "lost" if it hasn't been found within 21 days. The compensation 
            approach differs: for delayed baggage, you can claim essentials while waiting; for lost baggage, you claim for the 
            full value of the luggage and its contents.
          </AccordionContent>
        </AccordionItem>
        
        <AccordionItem value="item-2">
          <AccordionTrigger className="text-lg font-medium">Can I claim for emotional distress caused by lost luggage?</AccordionTrigger>
          <AccordionContent className="text-gray-700">
            Generally, no. The Montreal Convention limits compensation to material damages and doesn't provide for compensation 
            for emotional distress or inconvenience. Your claim should focus on the actual financial losses incurred due to the 
            baggage issue, such as the value of lost items or costs of essential purchases while waiting for delayed baggage.
          </AccordionContent>
        </AccordionItem>
        
        <AccordionItem value="item-3">
          <AccordionTrigger className="text-lg font-medium">What if the airline offers vouchers instead of cash compensation?</AccordionTrigger>
          <AccordionContent className="text-gray-700">
            Airlines often try to offer vouchers for future flights instead of cash compensation. You are not obligated to accept 
            this offer. Under the Montreal Convention, you are entitled to monetary compensation for your losses up to the 
            maximum liability limit. If you prefer cash compensation, you can insist on this and reject voucher offers.
          </AccordionContent>
        </AccordionItem>
        
        <AccordionItem value="item-4">
          <AccordionTrigger className="text-lg font-medium">Does travel insurance cover what airlines don't?</AccordionTrigger>
          <AccordionContent className="text-gray-700">
            Yes, comprehensive travel insurance often provides additional coverage beyond airline liability limits. Many policies 
            include higher compensation limits for baggage and may cover items that airlines typically exclude (like electronics 
            or jewelry). They may also offer immediate emergency funds for essential purchases without waiting for airline 
            reimbursement. Always check your policy details before traveling.
          </AccordionContent>
        </AccordionItem>
      </Accordion>
      ...
      <div className="grid md:grid-cols-2 gap-8 my-8">
        <div className="bg-blue-50 p-6 rounded-lg">
          <h3 className="text-xl font-semibold mb-3">Need Help With Your Baggage Claim?</h3>
          <p className="mb-4">
            Getting proper compensation for baggage issues can be challenging. Our experts can help you navigate the process 
            and maximize your chances of a successful claim.
          </p>
