...
import { prepareClaimDataForSubmission } from '../components/admin/utils/claimDataProcessor';
...
export function useEditClaimForm({
  ...
  const [formState, setFormState] = useState({
    ...
    accountHolderName:
      paymentDetails.accountName || paymentDetails.accountHolderName || '',
