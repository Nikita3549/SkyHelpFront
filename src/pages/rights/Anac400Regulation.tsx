...
import { InfoIcon, FileTextIcon, AlertTriangleIcon, CheckIcon } from "lucide-react";
...
const Anac400Regulation = () => {
  ...
  return (
    ...
    >
      <h2 id="understanding" className="text-2xl font-bold mb-4 scroll-mt-24">Understanding ANAC 400 Regulation: Air Passenger Rights in Brazil</h2>
      ...
      >
        <p className="text-lg">
          <strong>Quick Summary:</strong> ANAC 400 is Brazil's air passenger rights regulation that protects travelers on flights to, 
          from, and within Brazil. Unlike EU261, it focuses on providing immediate material assistance rather than 
          standardized financial compensation.
        </p>
      </RightsInfoBox>
      ...
      <h3 id="what-is-anac" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">What is ANAC 400?</h3>
      <p>
        ...
        cards={[
          {
            ...
            description: "Delays, cancellations, and denied boarding situations"
          },
          {
            icon: <AlertTriangleIcon className="w-6 h-6" />,
            title: "Baggage Issues",
            description: "Lost, damaged, or delayed baggage handling and compensation"
          },
          {
            icon: <CheckIcon className="w-6 h-6" />,
            title: "Consumer Rights",
            description: "Ticket refund policies and passenger assistance requirements"
          }
        ]}
      />

      <h3 id="when-apply" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">When Does ANAC 400 Apply?</h3>
      <p>
        ANAC 400 applies to:
      </p>
      ...
      <h3 id="your-rights" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">Your Rights Under ANAC 400: Flight Delays and Cancellations</h3>

      <h4 className="text-lg font-semibold mt-6 mb-3">Material Assistance Based on Delay Length</h4>
      <p>
      ...
      <h4 className="text-lg font-semibold mt-6 mb-3">Options for Cancelled Flights or Delays Over 4 Hours</h4>
      <p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-6">
        <div className="bg-blue-50 p-5 rounded-lg text-center">
          ...
          <p className="text-sm">Complete refund of your ticket including all taxes and fees</p>
        </div>
        <div className="bg-blue-50 p-5 rounded-lg text-center">
          <span className="text-xl font-bold text-primary block mb-2">2</span>
          <h5 className="font-medium mb-2">Re-routing</h5>
          <p className="text-sm">Flight on another airline to your destination, at no extra cost</p>
        </div>
        <div className="bg-blue-50 p-5 rounded-lg text-center">
          <span className="text-xl font-bold text-primary block mb-2">3</span>
          <h5 className="font-medium mb-2">Rebooking</h5>
          <p className="text-sm">Change to a future date at your convenience at no extra cost</p>
        </div>
      </div>
      ...
      <Tabs defaultValue="denied" className="mt-8">
        ...
        <TabsContent value="denied" className="py-4">
          <h3 id="denied-boarding" className="text-xl font-bold mb-4">Denied Boarding Rights Under ANAC 400</h3>
          <p>
        ...
        <TabsContent value="baggage" className="py-4">
          <h3 id="baggage-rights" className="text-xl font-bold mb-4">Baggage Rights Under ANAC 400</h3>
          <p>
        ...
        <TabsContent value="refund" className="py-4">
          <h3 id="ticket-refunds" className="text-xl font-bold mb-4">Ticket Refund Rights</h3>
          <p>
      ...
      <h3 id="how-to-claim" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">How to Claim Your Rights Under ANAC 400</h3>
      ...
      <h3 id="unique-features" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">Unique Features of ANAC 400</h3>
      <p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
        <div className="border border-blue-100 p-5 rounded-lg bg-blue-50">
          <h4 className="font-semibold mb-2">No Extraordinary Circumstances Exemption</h4>
          <p>Unlike EU261, assistance must be provided regardless of the cause of disruption</p>
        </div>
        <div className="border border-blue-100 p-5 rounded-lg bg-blue-50">
          <h4 className="font-semibold mb-2">Re-routing Responsibility</h4>
          <p>Airlines must re-route passengers on other carriers if necessary, not just on their own flights</p>
        </div>
        <div className="border border-blue-100 p-5 rounded-lg bg-blue-50">
          <h4 className="font-semibold mb-2">Real-time Information</h4>
          <p>Airlines must keep passengers informed about flight status in real-time</p>
        </div>
        <div className="border border-blue-100 p-5 rounded-lg bg-blue-50">
          <h4 className="font-semibold mb-2">Accessible Channels</h4>
          <p>Airlines must provide multiple accessible channels for passenger communication</p>
        </div>
      </div>

      <h3 id="time-limits" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">Time Limits for Claims</h3>
      <p>
      ...
      <RightsCallToAction 
        ...
        additionalInfo={["Expert handling of ANAC regulations", "Local representatives in Brazil"]}
        className="mt-10"
      />
    </RightsPageLayout>
  );
