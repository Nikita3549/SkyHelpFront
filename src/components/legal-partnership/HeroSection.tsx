        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
              Join SkyHelp's growing network of legal professionals. Refer
              delayed or cancelled flight cases and earn by helping passengers
              claim what they're legally entitled to.
            </p>
