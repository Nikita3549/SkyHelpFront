...
const DeniedBoardingCompensation = () => {
  ...
  const tableOfContents = [
    ...
    { id: "additional-rights", title: "Additional Rights When Denied Boarding" },
    { id: "voluntary-vs-involuntary", title: "Voluntary vs. Involuntary Denied Boarding" },
  ...
  return (
    ...
    >
      <h2 id="understanding" className="text-2xl font-bold mb-4 scroll-mt-24">Understanding Denied Boarding</h2>
      <div className="bg-blue-50 p-6 rounded-lg mb-6">
        <p className="text-lg">
          <strong>Quick Summary:</strong> Under EU Regulation 261/2004, if you're denied boarding against your will 
          on a flight for which you have a valid reservation and have checked in on time, you could be entitled to 
          compensation of up to €600, immediate assistance, and the choice between a refund or re-routing.
        </p>
      </div>

      <p>
        Being denied boarding is a frustrating experience that can severely disrupt your travel plans. This most commonly 
        happens due to overbooking, where airlines sell more tickets than available seats on the flight. Under EU Regulation 261/2004, 
        passengers have specific rights when they're denied boarding against their will.
      </p>

      <h3 id="eligibility" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">When Are You Eligible for Compensation?</h3>
      <p>
        You may be entitled to compensation for denied boarding if:
      </p>
      <ul className="list-disc pl-6 mb-6 space-y-2">
        <li>You have a valid ticket and booking confirmation</li>
        <li>You checked in on time (or at least within the airline's stated deadline)</li>
        ...
        <li>The flight was scheduled to depart from an EU airport, or was operated by an EU airline flying into an EU airport</li>
      </ul>

      <h3 id="compensation-amount" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">How Much Compensation Can You Get?</h3>
      <p className="mb-4">
        If you're involuntarily denied boarding, you're entitled to immediate compensation based on the flight distance:
      </p>
      ...
      <div className="bg-blue-50 p-6 rounded-lg my-6">
        ...
        <p>
          This compensation must be paid immediately at the airport, in cash, by electronic bank transfer, or by check. 
          Airlines may offer travel vouchers, but you have the right to demand payment in one of these forms instead.
        </p>
      </div>

      <h3 id="additional-rights" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">Additional Rights When Denied Boarding</h3>
      <p>
      ...
      <h3 id="voluntary-vs-involuntary" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">Voluntary vs. Involuntary Denied Boarding</h3>
      <div className="grid md:grid-cols-2 gap-6 my-6">
        <div className="bg-blue-50 p-6 rounded-lg">
          <h4 className="font-semibold text-lg mb-3">Voluntary</h4>
          <p>
            When a flight is overbooked, airlines typically ask for volunteers to give up their seats in exchange for 
            benefits (like travel vouchers or upgrades). If you <strong>voluntarily</strong> surrender your seat, you're not entitled to 
            the standard compensation, but you should still receive the benefits agreed upon with the airline.
          </p>
        </div>
        <div className="bg-gray-50 p-6 rounded-lg">
          <h4 className="font-semibold text-lg mb-3">Involuntary</h4>
          <p>
            If not enough passengers volunteer and you're <strong>involuntarily</strong> denied boarding, you're entitled to the full 
            compensation under EU261, assistance, and your choice of reimbursement or re-routing.
          </p>
        </div>
      </div>

      <h3 id="exceptions" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">Exceptions to Compensation</h3>
      <p>
      ...
      <h3 id="how-to-claim" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">How to Claim Compensation for Denied Boarding</h3>
      ...
      <div className="my-8">
        ...
        <p className="mb-4">
          The time limit for filing a denied boarding compensation claim varies by country:
        </p>
      ...
      <h3 id="faq" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">Frequently Asked Questions</h3>
      <div className="space-y-4 mb-6">
        <div className="border-b pb-4">
          <p><strong>Can airlines legally overbook flights?</strong></p>
          <p>Yes, airlines legally can overbook flights. However, they must first ask for volunteers before involuntarily denying boarding to passengers.</p>
        </div>
        <div className="border-b pb-4">
          <p><strong>What if I'm traveling as part of a group and only some of us are denied boarding?</strong></p>
          <p>Each passenger denied boarding is individually entitled to compensation. However, if you're traveling as a family with children, the airline should prioritize keeping your group together.</p>
        </div>
        <div className="border-b pb-4">
          <p><strong>Can I claim compensation if I voluntarily gave up my seat?</strong></p>
          <p>If you voluntarily surrendered your seat in exchange for benefits offered by the airline, you're not entitled to the standard compensation under EU261. The benefits you receive are determined by your agreement with the airline.</p>
        </div>
        <div className="border-b pb-4">
          <p><strong>What if the airline offers me a voucher instead of cash compensation?</strong></p>
          <p>Airlines may offer vouchers, but you have the right to demand payment in cash, by electronic bank transfer, or by check instead. Only accept a voucher if its value exceeds the compensation you're entitled to by law.</p>
        </div>
      </div>
