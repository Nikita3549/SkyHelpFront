...
const galleryImages = [
  ...
  },
  {
    ...
    subcaption:
      'Easily upload and analyze thousands of passenger flights to detect eligible claims.',
  },
  {
    ...
    subcaption:
      "Track your agency's commissions, payouts, and claim activity in real time.",
  },
];
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            SkyHelp works with a variety of businesses in the travel industry
            and beyond.
          </p>
        </motion.div>
