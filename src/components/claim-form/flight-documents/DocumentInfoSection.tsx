        ...
        <AccordionItem value="boarding-pass-info" className="border-0">
          <div className="bg-blue-50 rounded-lg p-4 border border-blue-100">
            ...
            <AccordionContent className="pt-4 pb-0 text-sm text-gray-700 leading-relaxed">
              <p className="mb-3">
                The <span className="font-medium text-gray-900">boarding pass</span> is the physical slip you receive after checking in at the airport, or an in-app document if you check-in online. You use this to board the plane and it has details like your name and seat number.
              </p>
              <p>
