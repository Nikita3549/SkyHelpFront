...
const countriesWithDialCodes: (CountryOption & { dialCode: string })[] = [
  ...
  { label: "Bosnia and Herzegovina", value: "BA", flag: "🇧🇦", dialCode: "+387" },
  ...
  { label: "Central African Republic", value: "CF", flag: "🇨🇫", dialCode: "+236" },
  ...
  { label: "Saint Vincent and the Grenadines", value: "VC", flag: "🇻🇨", dialCode: "+1" },
...
const PhoneInput: React.FC<PhoneInputProps> = ({
  ...
  const [selectedCountry, setSelectedCountry] = useState<(typeof countriesWithDialCodes)[0] | null>(null);
  ...
  useEffect(() => {
    ...
    if (!value && !selectedCountry) {
      const defaultCountryOption = countriesWithDialCodes.find(c => c.value === defaultCountry);
