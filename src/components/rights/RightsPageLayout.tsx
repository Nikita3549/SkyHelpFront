              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-600 mb-6">
                    Our team of experts is ready to help you get the
                    compensation you deserve. Start your claim today and let us
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    Find out in just a few clicks if you're eligible for
                    compensation.
                  </p>
