...
const ShyRegulationTurkey = () => {
  ...
  const faqs = [
    {
      ...
      answer: "While similar in structure, SHY Regulation offers lower compensation amounts (100-300 EUR vs. 250-600 EUR under EU261) and requires only 10 days notice for cancellations to avoid compensation (vs. 14 days under EU261). Technical issues are also more likely to be considered extraordinary circumstances under Turkish regulations."
    },
    {
      question: "Can I claim under both EU261 and SHY Regulation for the same flight?",
      answer: "No, you can choose which regulation to claim under based on which is more favorable to your situation, but you cannot claim under both simultaneously for the same flight disruption."
    },
    {
      question: "How long do I have to make a claim under SHY Regulation?",
      answer: "The time limit for filing claims under SHY Regulation is generally 1 year from the date of the flight, compared to 3-6 years under EU261 (depending on the country)."
    },
    {
      question: "Does SHY Regulation cover flights to or from any country?",
      answer: "SHY Regulation covers flights departing from airports in Turkey (regardless of the airline's nationality) and flights arriving at airports in Turkey operated by Turkish carriers."
    }
  ];

  // Compensation table data
  const compensationHeaders = ["Flight Distance", "SHY Regulation", "EU Regulation 261"];
  ...
  return (
    ...
    >
      <h2 id="understanding" className="text-2xl font-bold mb-4 scroll-mt-24">Understanding SHY Regulation: Air Passenger Rights in Turkey</h2>
      ...
      >
        <p className="text-lg">
          <strong>Quick Summary:</strong> SHY Regulation is Turkey's equivalent to EU Regulation 261/2004, 
          providing compensation for flight disruptions to and from Turkish airports. Compensation ranges from 
          100 to 300 EUR depending on flight distance, which is lower than EU261 amounts but follows similar principles.
        </p>
      </RightsInfoBox>
      ...
      <h3 id="what-is-shy" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">What is SHY Regulation?</h3>
      <p>
      ...
      <h3 id="when-apply" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">When Does SHY Regulation Apply?</h3>
      <p>
      ...
      >
        <p>
          <strong>Important Note:</strong> When both EU261 and SHY regulations could apply to a flight, 
          passengers can choose which regulation to claim under, but cannot claim under both simultaneously.
          This typically happens for flights between Turkey and EU countries on Turkish carriers.
        </p>
      </RightsInfoBox>

      <h3 id="compensation" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">Compensation Under SHY Regulation</h3>
      <p>
      ...
      <p className="mt-4">
        Note that these amounts are lower than the EU261 compensation. Compensation is 
        typically paid in Turkish lira at the exchange rate on the date of payment.
      </p>

      <h3 id="rights" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">Your Rights Under SHY Regulation</h3>
      ...
      <h3 id="claim" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">How to Claim Under SHY Regulation</h3>
      ...
      <h4 className="text-lg font-semibold mt-6 mb-3">Time Limits for Filing Claims</h4>
      <p className="mb-4">
      ...
      <h4 className="text-lg font-semibold mt-6 mb-3">Extraordinary Circumstances</h4>
      <p className="mb-4">
      ...
      >
        <p>
          The interpretation of "extraordinary circumstances" under SHY Regulation may differ slightly from EU261, 
          particularly regarding technical issues, which are more often accepted as extraordinary circumstances under Turkish regulation.
        </p>
      </RightsInfoBox>
      ...
      <RightsCallToAction 
        ...
        additionalInfo={["Average claim takes just 3 minutes to start", "Expert handling of Turkish airlines communication"]}
      />
    </RightsPageLayout>
  );
};
