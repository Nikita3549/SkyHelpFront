  ...
  const faqs = [
    {
      ...
      answer:
        'EU Regulation 261/2004 is a European law that establishes common rules on compensation and assistance to passengers in the event of denied boarding, flight cancellations, or long delays. It applies to all flights departing from an EU airport and flights arriving in the EU with an EU-based carrier.',
    },
    {
      question: 'How much compensation can I claim?',
      answer:
        'Under EU Regulation 261/2004, you may be entitled to: €250 for flights up to 1,500 km, €400 for flights between 1,500 and 3,500 km, and €600 for flights over 3,500 km. The exact amount depends on the distance of your flight and the length of the delay.',
    },
    {
      question: 'What flight problems are eligible for compensation?',
      answer:
        'You may be eligible for compensation if your flight was: Cancelled without sufficient notice, Delayed by more than 3 hours at the final destination, or if you were denied boarding due to overbooking. Note that extraordinary circumstances like severe weather or security risks may exempt airlines from paying compensation.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'To process your claim, we need: Your flight details (number, date, route), Booking reference, Your personal information, A description of what happened, and Any relevant documentation you have (boarding passes, emails from the airline, etc.).',
    },
  ];
