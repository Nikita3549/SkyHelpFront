...
import { FileText, Upload, Check, Clock, Download } from 'lucide-react';
        ...
        {claim.status === 'in_progress' && (
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                We're working with the airline to process your claim. We'll
        ...
        {claim.status === 'completed' && (
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Your claim has been successfully processed and payment has been
                made.
              </p>
