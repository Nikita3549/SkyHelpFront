    ...
    <div className="space-y-4 pt-2">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          ...
          {errors.arrivalAirport && (
            <p className="text-sm text-red-500">{errors.arrivalAirport}</p>
          )}
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        >
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="flight-delayed" className="cursor-pointer">
              Flight was delayed
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            <RadioGroupItem value="canceled" id="flight-canceled" />
            <Label htmlFor="flight-canceled" className="cursor-pointer">
              Flight was canceled
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            <RadioGroupItem value="overbooking" id="flight-overbooking" />
            <Label htmlFor="flight-overbooking" className="cursor-pointer">
              Overbooking
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            <RadioGroupItem
              ...
              id="flight-missed-connection"
            />
            <Label
              htmlFor="flight-missed-connection"
        ...
        {errors.flightIssue && (
          <p className="text-sm text-red-500">{errors.flightIssue}</p>
        )}
      </div>
      ...
      {flightIssue === 'delayed' && (
        <div className="space-y-2">
          ...
          {errors.delayDuration && (
            <p className="text-sm text-red-500">{errors.delayDuration}</p>
          )}
        </div>
      )}
      ...
      <div className="space-y-2">
        ...
        {errors.reasonGivenByAirline && (
          <p className="text-sm text-red-500">{errors.reasonGivenByAirline}</p>
        )}
      </div>
    </div>
  );
