      ...
      <tbody>
        <tr>
          ...
          <td className="py-2 px-4 border border-gray-200">
            Flights departing from EU or arriving in EU on EU carriers
          </td>
          <td className="py-2 px-4 border border-gray-200">
            Flights departing from UK or arriving in UK on UK/EU carriers
          </td>
        </tr>
        <tr>
          <td className="py-2 px-4 border border-gray-200">
            Compensation (short flights)
          </td>
