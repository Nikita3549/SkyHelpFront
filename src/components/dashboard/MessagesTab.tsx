        ...
        {messages.map((message, index) => (
          ...
          >
            ...
            >
              ...
              {message.content && (
                <p
                  className={`text-sm mb-2 ${message.isFromTeam ? 'text-gray-700' : 'text-white'}`}
                >
                  {message.content}
                </p>
              )}
                  ...
                  {message.attachments.map((attachment, attachIndex) => (
                    ...
                    >
                      <div className="flex items-center space-x-2">
                        <Paperclip
                          className={`h-3 w-3 ${message.isFromTeam ? 'text-gray-400' : 'text-white/70'}`}
                        />
                        <div>
                          <p
                          ...
                          <p
                            className={`text-xs ${message.isFromTeam ? 'text-gray-500' : 'text-white/70'}`}
                          >
