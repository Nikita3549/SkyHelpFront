...
const faqItems = [
  {
    ...
    answer:
      'Legal partners typically earn 15-25% commission on each successful claim. The exact amount depends on the claim value and partnership tier. For an average EU261 claim of €600, partners can earn between €90-150 per successful case.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Partner commissions are processed monthly for all successful claims closed in the previous month. Payments are typically made within the first 10 business days of each month.',
  },
  {
    question: 'What support do legal partners receive?',
    answer:
      'Partners receive access to a dedicated dashboard, marketing materials, technical support, and a personal account manager to help maximize your referrals and earnings.',
  },
];
