...
const OverbookedFlightCompensation = () => {
  ...
  return (
    ...
    >
      <h2 id="understanding" className="text-2xl font-bold mb-4 scroll-mt-24">Understanding Overbooked Flights</h2>
      <div className="bg-blue-50 p-6 rounded-lg mb-6">
        <p className="text-lg">
          <strong>Quick Summary:</strong> When airlines overbook flights and you're denied boarding against your will, 
          EU Regulation 261/2004 entitles you to immediate compensation ranging from €250 to €600, plus your choice of 
          a refund or re-routing to your destination.
        </p>
      </div>
      ...
      <h3 id="what-is" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">What is Flight Overbooking?</h3>
      <p>
      ...
      <h3 id="your-rights" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">Your Rights When Denied Boarding Due to Overbooking</h3>
      <p>
      ...
      <h4 className="text-lg font-semibold mt-6 mb-3">Right to Choose Between</h4>
      ...
      <h3 id="how-to-claim" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">How to Claim Compensation for an Overbooked Flight</h3>
      <p>
        If you've been denied boarding due to overbooking, follow these steps:
      </p>
      <ol className="list-decimal pl-6 mb-6 space-y-3">
        <li><strong>Collect evidence:</strong> Make sure you get written confirmation of why you were denied boarding</li>
        <li><strong>Keep all documentation</strong> related to the incident and your original booking</li>
        <li><strong>Gather evidence</strong> of any additional expenses incurred due to the denied boarding</li>
        <li><strong>Contact the airline</strong> directly and submit a formal claim for compensation</li>
        <li><strong>Be persistent:</strong> Airlines might initially reject your claim</li>
      </ol>

      <div className="bg-gray-50 p-5 rounded-lg my-5">
        <p>
          If the airline refuses to compensate you adequately despite your persistent efforts, consider seeking professional help from
          a specialized company like CleverClaim to handle your case.
        </p>
      </div>

      <h3 id="time-limits" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">Time Limits for Making a Claim</h3>
      <p>
      ...
      <h3 id="maximizing" className="text-xl font-bold mt-8 mb-4 scroll-mt-24">Maximizing Your Rights When Faced with an Overbooked Flight</h3>
      <div className="bg-blue-50 p-6 rounded-lg mb-6">
